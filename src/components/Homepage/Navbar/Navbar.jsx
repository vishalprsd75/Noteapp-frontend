...
export default function Navbar() {
  ...
  return (
    <>
      <Box zIndex={1000} position={"fixed"} top={0} w={"100%"}  boxShadow={"rgba(0, 0, 0, 0.16) 0px 3px 6px, rgba(0, 0, 0, 0.23) 0px 3px 6px;"}   className="gradient" px={4}>
            ...
            <Stack alignItems={"center"} direction={'row'} spacing={7}>
              ...
              <Menu>
                <MenuButton
                  ...
                  <Avatar
                    size={'sm'}
                    src="https://api.dicebear.com/6.x/personas/svg?seed=Casper&flip=true"
                    alt="avatar" />
                </MenuButton>
